...
const MediaCard = ({ media, type }: MediaCardProps) => {
  ...
  return (
    <Link
      to={`/${type}/${media.id}`}
      className="group relative block bg-gray-900 rounded-lg overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/20"
    >
